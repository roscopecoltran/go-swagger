...
import (
	...
	"github.com/roscopecoltran/go-swagger/examples/tutorials/custom-server/gen/restapi"
	"github.com/roscopecoltran/go-swagger/examples/tutorials/custom-server/gen/restapi/operations"
)
