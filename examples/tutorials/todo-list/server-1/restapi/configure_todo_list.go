...
import (
	...
	"github.com/roscopecoltran/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/roscopecoltran/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
