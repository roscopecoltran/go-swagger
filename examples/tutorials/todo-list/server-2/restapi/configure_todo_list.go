...
import (
	...
	"github.com/roscopecoltran/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/roscopecoltran/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
